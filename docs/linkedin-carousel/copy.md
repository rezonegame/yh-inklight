...
Highlight Markdown and PDFs like paper.
Keep the original files clean.

## Slide 2
The problem:
Obsidian is great for thinking, but reading inside it still feels too much like editing.

I wanted highlights, margin notes, and sticky notes.
I did not want to write visual clutter into my Markdown.
...
Each passage becomes one clean card: the highlighted quote, your note, Jump, edit, and export.

## Slide 5
Every highlight and note is useful later.

Search them.
Jump back to the source.
Export everything into a new Markdown note.

## Slide 6
The core promise:
Annotations are annotations.
Original files are original files.

Markdown and PDFs stay untouched.
